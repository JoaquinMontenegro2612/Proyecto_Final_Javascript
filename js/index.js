            ...
            productos.forEach(producto => {
                {
                    productosPanelVista +=
                        ` <div class="container">
                    <section class="column-xs main-xs-between cross-xs-center full-image-wrap">
                    <img id="fotoProducto" class="d-block w-100" src="${producto.Foto}">
                    ...
                    <div class="input-group p-5 my-1">
                    ...
                    <button id="${producto.Id}" onclick="agregar('${producto.Id}')" name="btnComprar" class="btn btn-success">Comprar</button>
                    </div>   
                    `
                }
